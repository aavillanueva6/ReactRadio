...
const placeholderCards: number[] = [0, 1, 2, 3, 4, 5, 6, 7];

const PHShowCardShort = () => {
  return (
    <>
      {placeholderCards.map((e: number) => {
        return (
          <div
              ...
              <div className='col-md-8'>
                <div className='card-body placeholder-glow'>
                  ...
                  <p className='card-text placeholder'>
                    This is a two sentence bit of text to use as a placeholder
                    while loading data. There is nothing to see here.
                  </p>
                </div>
              </div>
            </div>
